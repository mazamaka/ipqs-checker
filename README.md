...
5. Выбери файл **manifest.json** и нажми "Открыть"

6. Иконка расширения появится в панели инструментов

> **Примечание:** Временное расширение удаляется при перезапуске Firefox. Для постоянной установки требуется подпись Mozilla.
